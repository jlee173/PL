...
int main(int argc, char **argv)
{
  ...
  // if -DGRAPHICS was specified when compiling gpl.cpp then include this code
    ...
    if (symbol != NULL)
    {
      ...
      else window_width = symbol->get_int();
    }
    ...
    if (symbol != NULL)
    {
      ...
      else window_height = symbol->get_int();
    }
    ...
    if (symbol != NULL)
    {
      ...
      else window_red = symbol->get_double();
    }
    ...
    if (symbol != NULL)
    {
      ...
      else window_green = symbol->get_double();
    }
    ...
    if (symbol != NULL)
    {
      ...
      else window_blue = symbol->get_double();
    }
    ...
    if (symbol != NULL)
    {
      ...
      else window_title = symbol->get_string();
    }
    ...
    if (symbol != NULL)
    {
      ...
      else animation_speed = symbol->get_int();
    }
  #endif
